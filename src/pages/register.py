...
def build(page: ft.Page) -> ft.View:
    ...
    phone_field = ft.TextField(
        label="Phone Number", width=300, keyboard_type=ft.KeyboardType.PHONE
    )
    email_field = ft.TextField(
        label="E-mail", width=300, keyboard_type=ft.KeyboardType.EMAIL
    )
    ...
    return ft.View(
        route="/register",
        controls=[ft.SafeArea(expand=True, content=main_content)],
        horizontal_alignment=ft.CrossAxisAlignment.CENTER,
